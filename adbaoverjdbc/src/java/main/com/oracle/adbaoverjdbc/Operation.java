...
abstract class Operation<T> implements jdk.incubator.sql2.Operation<T> {
  ...
  static {
    ...
    ADBATYPE_TO_JDBCTYPE.put(AdbaType.TIME_WITH_TIMEZONE, JDBCType.TIME_WITH_TIMEZONE);
    ADBATYPE_TO_JDBCTYPE.put(AdbaType.TIMESTAMP_WITH_TIMEZONE, JDBCType.TIMESTAMP_WITH_TIMEZONE);
